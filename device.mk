...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/permissions/id.xyz_gapps_permissions.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/id.xyz_gapps_permissions.xml \
    $(LOCAL_PATH)/permissions/id.xyz_gapps_permissions.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/id.xyz_gapps_permissions.xml \
    $(LOCAL_PATH)/permissions/id.xyz_android_permissions.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/id.xyz_android_permissions.xml \
    $(LOCAL_PATH)/permissions/id.xyz_android_permissions.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/id.xyz_android_permissions.xml
